...
<div data-role="delete"><?php echo $me->getText('error/deletedeMent'); ?></div>
<?php } else { ?>
...
<div>
	<div class="info">
		...
		<ul>
			<li><button type="button" data-ment-action="reply"><i class="xi xi-reply-all xi-rotate-180"></i>답변</button></li>
			<li><button type="button" data-ment-action="modify"><i class="xi xi-pen"></i>수정</button></li>
			<li><button type="button" data-ment-action="delete"><i class="xi xi-trash"></i>삭제</button></li>
		</ul>
	</div>
